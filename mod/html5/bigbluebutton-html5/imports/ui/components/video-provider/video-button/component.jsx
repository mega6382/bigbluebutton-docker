...
const JoinVideoButton = ({
  ...
  <svg viewBox="2.664 9.799 19.235 10.91" xmlns="http://www.w3.org/2000/svg">
    <path d="M 20.565 10.54 L 16.696 12.595 L 16.696 11.932 C 16.696 10.753 15.662 9.799 14.389 9.799 L 4.973 9.799 C 3.697 9.799 2.664 10.753 2.664 11.932 L 2.664 18.576 C 2.664 19.755 3.697 20.709 4.973 20.709 L 14.389 20.709 C 15.662 20.709 16.696 19.755 16.696 18.576 L 16.696 17.913 L 20.565 19.968 C 21.297 20.358 21.899 20.038 21.899 19.257 L 21.899 11.255 C 21.899 10.47 21.298 10.15 20.565 10.54 Z" style="" transform="matrix(1, 0, 0, 1, 0, 7.105427357601002e-15)"/>
  </svg>: 
    <svg viewBox="1.7845 7.6592 20.1145 15.4615" xmlns="http://www.w3.org/2000/svg">
    <path d="M 20.565 10.54 L 16.696 12.595 L 16.696 11.932 C 16.696 10.753 15.662 9.799 14.389 9.799 L 4.973 9.799 C 3.697 9.799 2.664 10.753 2.664 11.932 L 2.664 18.576 C 2.664 19.755 3.697 20.709 4.973 20.709 L 14.389 20.709 C 15.662 20.709 16.696 19.755 16.696 18.576 L 16.696 17.913 L 20.565 19.968 C 21.297 20.358 21.899 20.038 21.899 19.257 L 21.899 11.255 C 21.899 10.47 21.298 10.15 20.565 10.54 Z" style="" transform="matrix(1, 0, 0, 1, 0, 7.105427357601002e-15)"/>
    <path d="M 17.413 21.807 L 13.605 18.096 L 6.069 10.752 L 3.134 7.891 C 2.816 7.582 2.341 7.582 2.023 7.891 C 1.705 8.2 1.705 8.664 2.023 8.974 L 3.848 10.752 C 3.339 10.299 12.775 19.554 12.811 19.488 L 16.302 22.889 C 16.62 23.198 17.095 23.198 17.413 22.889 C 17.73 22.58 17.73 22.116 17.413 21.807 Z" style="fill: rgb(255, 0, 0);" transform="matrix(1, 0, 0, 1, 0, 7.105427357601002e-15)"/>
  </svg>;
